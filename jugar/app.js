...
%%EOF`;
  ...
  function maybeMondayHint() {
    ...
    if (low.length) {
      showToast(`Lunes: ${low.length} rascas bajos de stock \xB7 Extracto semanal + inventario rascas`);
    } else {
    ...
    <div class="menu-screen menu-v1">
      ...
      return `<div class="slot slot-filled">
        ...
        <p class="disclaimer">
          ...
          Juego responsable \xB7 +18. Versi\xF3n ${GAME_VERSION}: cifras del cliente, atajos TPV, errores de cobro, PDF con estilo y men\xFAs a todo color.
        </p>
      </div>
    </div>
  `;
  ...
  function renderCash() {
    ...
    if (ps.step === "electronic") {
      ...
      <div class="pay-window pay-cash">
        ...
        ${need > 0 ? `<h3 style="margin-top:16px">Tu turno: calcula el cambio</h3>
               ...
               ${denomEditor("change")}` : `<div class="alert-banner" style="margin-top:12px"><strong>Importe exacto</strong> \u2014 no hay cambio que devolver.</div>`}
        <div class="actions" style="margin-top:12px">
  ...
  `;
    ...
    if (elec) {
      elec.onclick = () => {
        ...
        if (((_a = state.ui.paymentSession) == null ? void 0 : _a.step) === "done") sfx.cash();

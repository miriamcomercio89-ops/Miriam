(() => {
  ...
  function migrateState(data) {
    ...
    if (data.customers && data.clock) {
      ...
      if (gap >= 0 && gap < 10 * 60 * 1e3) {
        data.customers.nextSpawnAtMs = data.clock.gameTimeMs + 4e4 * 30;
      }
    }
  ...
  function speedLabel(speed, paused) {
    ...
    if (speed === 2) return "R\xE1pido (1 min = 1 h)";
    if (speed === 4) return "Muy r\xE1pido (1 min = 2 h)";
    ...
    <div class="menu-screen menu-v1">
      ...
      return `<div class="slot slot-filled">
        ...
        <p class="disclaimer">
          ...
          Juego responsable \xB7 +18. Versi\xF3n ${GAME_VERSION}: 1 min real = 30 min juego \xB7 teclado num\xE9rico \xB7 fondo de cambio lunes \xB7 propinas / sin cambio.
        </p>
      </div>
    </div>
  `;
  ...
  function topbarHTML() {
    ...
    <header class="topbar">
      ...
      <div class="speed-controls">
        ...
        <button class="btn ${speed === 2 ? "active" : ""}" data-speed="2" title="1 min real = 1 h juego">R\xE1pido</button>
        <button class="btn ${speed === 4 ? "active" : ""}" data-speed="4" title="1 min real = 2 h juego">Muy r\xE1pido</button>
      </div>
    </header>

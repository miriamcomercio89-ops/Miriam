(() => {
  ...
  function getLinesForStation(stationId) {
    ...
    if (!st) return [];
    return lines.filter(
      (l) => l.stationIds.some((sid) => {
        const s = stations[sid];
        return sid === stationId || s && s.x === st.x && s.y === st.y;
      })
    );
  }
  function getLinePath(line2) {
    return line2.stationIds.map((id) => stations[id]).filter(Boolean).map((s) => ({ x: s.x, y: s.y }));
  }
  function findLineByCode(code) {
    const c = code.trim().toLowerCase();
    return lines.find((l) => l.code.toLowerCase() === c || l.id === c);
  }
  function getLineBounds(line2) {
  ...
  function delayLabel(line2) {
    ...
    if (line2.status === "suspendida") return "Sin servicio";
  ...
  function DetailPanel({
    ...
    if (station && !line2) {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "detail-panel", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", className: "detail-close", onClick: onClose, "aria-label": "Cerrar", children: "\xD7" }),
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "detail-panel", style: { ["--accent"]: line2.color }, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "detail-pills", children: [
        ...
        delay && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "pill warn", children: delay })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "button",
        {
          ...
          className: "share-btn",
          onClick: async () => {
            const link = shareLineUrl(line2.code);
            try {
          ...
          children: copied ? "Enlace copiado" : `Compartir ${line2.code}`
        }
      ),
      role === "operador" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "operator-box", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "occ-bar", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "div",
          {
            className: "occ-fill",
            style: {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("ul", { children: [
        MODE_LEGEND.map(({ mode, style }) => {
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("li", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("svg", { width: "28", height: "10", "aria-hidden": true, children: [
              s.glow && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                "line",
                {
                  x1: "1",
                  y1: "5",
            ...
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: MODE_LABELS[mode] })
          ] }, mode);
        }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("li", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("svg", { width: "28", height: "14", "aria-hidden": true, children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("circle", { cx: "14", cy: "7", r: "5", fill: "#eef1f4", stroke: "#1a2332", strokeWidth: "2" }),
  ...
  function buildGraph() {
    ...
    for (const line2 of lines) {
      if (line2.status === "suspendida") continue;
  ...
  function RoutePlanner({ onRoute, onPickStation }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("section", { className: "route-planner", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("label", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: "Origen" }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("select", { value: fromId, onChange: (e) => {
          setFromId(e.target.value);
          clear();
        }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("option", { value: "", children: "Elegir estaci\xF3n\u2026" }),
          stations2.map((s) => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("option", { value: s.id, children: [
            s.name,
            " \xB7 ",
            s.district
          ] }, s.id))
      ...
      plan && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "route-result", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("ol", { className: "route-legs", children: plan.legs.map((leg, idx) => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("li", { children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "leg-text", children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", onClick: () => onPickStation(leg.fromId), children: stationLabel(leg.fromId) }),
            " \u2192 ",
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { type: "button", onClick: () => onPickStation(leg.toId), children: stationLabel(leg.toId) }),
  ...
  (() => {
    const style = document.createElement("style");
    style.textContent = ".side-panel {\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n  background: linear-gradient(165deg, #15202e 0%, #1a2332 45%, #121a26 100%);\n  color: #e8edf3;\n  border-right: 1px solid rgba(255, 255, 255, 0.06);\n}\n\n.side-brand {\n  padding: 1.35rem 1.25rem 1rem;\n  border-bottom: 1px solid rgba(255, 255, 255, 0.07);\n  background:\n    radial-gradient(ellipse at 20% 0%, rgba(196, 92, 38, 0.18), transparent 55%),\n    radial-gradient(ellipse at 100% 40%, rgba(56, 120, 160, 0.12), transparent 50%);\n}\n\n.brand-kicker {\n  margin: 0;\n  font-family: 'Sora', sans-serif;\n  font-size: 0.68rem;\n  letter-spacing: 0.18em;\n  text-transform: uppercase;\n  color: #c45c26;\n  font-weight: 600;\n}\n\n.brand-name {\n  margin: 0.25rem 0 0.35rem;\n  font-family: 'Sora', sans-serif;\n  font-size: 2rem;\n  font-weight: 700;\n  letter-spacing: -0.03em;\n  line-height: 1;\n}\n\n.brand-tag {\n  margin: 0;\n  font-size: 0.82rem;\n  color: rgba(232, 237, 243, 0.65);\n  line-height: 1.4;\n}\n\n.brand-stats {\n  display: grid;\n  grid-template-columns: repeat(3, 1fr);\n  gap: 0.5rem;\n  margin-top: 1rem;\n}\n\n.brand-stats div {\n  display: flex;\n  flex-direction: column;\n  gap: 0.15rem;\n}\n\n.brand-stats strong {\n  font-family: 'Sora', sans-serif;\n  font-size: 0.85rem;\n  font-weight: 600;\n  color: #fff;\n}\n\n.brand-stats span {\n  font-size: 0.65rem;\n  text-transform: uppercase;\n  letter-spacing: 0.06em;\n  color: rgba(232, 237, 243, 0.45);\n}\n\n.side-controls {\n  padding: 0.9rem 1rem;\n  display: flex;\n  flex-direction: column;\n  gap: 0.65rem;\n  border-bottom: 1px solid rgba(255, 255, 255, 0.06);\n}\n\n.search-wrap input {\n  width: 100%;\n  box-sizing: border-box;\n  padding: 0.65rem 0.8rem;\n  border-radius: 8px;\n  border: 1px solid rgba(255, 255, 255, 0.1);\n  background: rgba(0, 0, 0, 0.25);\n  color: #e8edf3;\n  font-family: 'Manrope', sans-serif;\n  font-size: 0.9rem;\n  outline: none;\n}\n\n.search-wrap input:focus {\n  border-color: rgba(196, 92, 38, 0.55);\n}\n\n.search-wrap input::placeholder {\n  color: rgba(232, 237, 243, 0.4);\n}\n\n.mode-filters {\n  display: flex;\n  flex-wrap: wrap;\n  gap: 0.35rem;\n}\n\n.mode-chip {\n  border: 1px solid rgba(255, 255, 255, 0.1);\n  background: transparent;\n  color: rgba(232, 237, 243, 0.75);\n  font-family: 'Manrope', sans-serif;\n  font-size: 0.72rem;\n  padding: 0.28rem 0.55rem;\n  border-radius: 6px;\n  cursor: pointer;\n  transition: background 0.15s, border-color 0.15s, color 0.15s;\n}\n\n.mode-chip:hover {\n  border-color: rgba(255, 255, 255, 0.25);\n  color: #fff;\n}\n\n.mode-chip.active {\n  background: #c45c26;\n  border-color: #c45c26;\n  color: #fff;\n}\n\n.clear-btn {\n  align-self: flex-start;\n  background: none;\n  border: none;\n  color: rgba(232, 237, 243, 0.55);\n  font-size: 0.75rem;\n  cursor: pointer;\n  text-decoration: underline;\n  padding: 0;\n  font-family: 'Manrope', sans-serif;\n}\n\n.clear-btn:hover {\n  color: #fff;\n}\n\n.line-list {\n  flex: 1;\n  overflow-y: auto;\n  padding: 0.5rem 0.65rem 1.5rem;\n}\n\n.line-group-section h2 {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  margin: 0.85rem 0.4rem 0.4rem;\n  font-family: 'Sora', sans-serif;\n  font-size: 0.7rem;\n  letter-spacing: 0.12em;\n  text-transform: uppercase;\n  color: rgba(232, 237, 243, 0.45);\n  font-weight: 600;\n}\n\n.line-group-section h2 span {\n  font-variant-numeric: tabular-nums;\n  letter-spacing: 0;\n}\n\n.line-row {\n  width: 100%;\n  display: flex;\n  align-items: center;\n  gap: 0.7rem;\n  padding: 0.55rem 0.55rem;\n  margin-bottom: 0.25rem;\n  border: 1px solid transparent;\n  border-radius: 8px;\n  background: transparent;\n  color: inherit;\n  text-align: left;\n  cursor: pointer;\n  font-family: 'Manrope', sans-serif;\n  transition: background 0.15s, border-color 0.15s;\n}\n\n.line-row:hover {\n  background: rgba(255, 255, 255, 0.05);\n}\n\n.line-row.selected {\n  background: rgba(196, 92, 38, 0.15);\n  border-color: rgba(196, 92, 38, 0.35);\n}\n\n.line-badge {\n  flex-shrink: 0;\n  min-width: 2.4rem;\n  text-align: center;\n  padding: 0.3rem 0.35rem;\n  border-radius: 5px;\n  background: var(--line-color);\n  color: #fff;\n  font-family: 'Sora', sans-serif;\n  font-size: 0.72rem;\n  font-weight: 700;\n  letter-spacing: 0.02em;\n  text-shadow: 0 1px 1px rgba(0, 0, 0, 0.25);\n}\n\n.line-meta {\n  display: flex;\n  flex-direction: column;\n  gap: 0.1rem;\n  min-width: 0;\n  flex: 1;\n}\n\n.line-name {\n  font-size: 0.86rem;\n  font-weight: 600;\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n\n.line-sub {\n  font-size: 0.7rem;\n  color: rgba(232, 237, 243, 0.5);\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n\n.status-dot {\n  width: 8px;\n  height: 8px;\n  border-radius: 50%;\n  flex-shrink: 0;\n  background: #f5a623;\n}\n\n.line-row.status-suspendida .status-dot {\n  background: #e53935;\n}\n\n.line-row.status-obras .status-dot {\n  background: #42a5f5;\n}\n\n.empty-list {\n  padding: 1.5rem 0.75rem;\n  color: rgba(232, 237, 243, 0.45);\n  font-size: 0.9rem;\n}\n\n.station-badge {\n  background: rgba(255, 255, 255, 0.12) !important;\n  color: #e8edf3 !important;\n  text-shadow: none !important;\n}\n\n.station-row:hover {\n  background: rgba(255, 255, 255, 0.05);\n}\n\n.sr-only {\n  position: absolute;\n  width: 1px;\n  height: 1px;\n  padding: 0;\n  margin: -1px;\n  overflow: hidden;\n  clip: rect(0, 0, 0, 0);\n  border: 0;\n}\n";
    document.head.appendChild(style);
  })();
  ...
  function LineRow({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
      ...
      {
        type: "button",
        className: `line-row ${selected ? "selected" : ""} status-${line2.status}`,
        onClick: onSelect,
        style: { ["--line-color"]: line2.color },
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "line-badge", children: line2.code }),
          ...
          line2.status !== "normal" && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "status-dot", title: STATUS_LABELS[line2.status] })
        ]
      }
    );
  }
  function SidePanel({
    ...
    const filteredLines = lines.filter((l) => {
      ...
      if (!q) return true;
      return l.code.toLowerCase().includes(q) || l.name.toLowerCase().includes(q) || MODE_LABELS[l.mode].toLowerCase().includes(q);
    });
    const stationMatches = q ? getUniqueStations().filter(
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("header", { className: "side-brand", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "brand-stats", children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("strong", { children: lines.length }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { children: "l\xEDneas" })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("strong", { children: getUniqueStations().length }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { children: "estaciones" })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("strong", { children: CITY.population }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { children: "hab." })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(RoutePlanner, { onRoute, onPickStation: onSelectStation }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "side-controls", children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("label", { className: "search-wrap", children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "sr-only", children: "Buscar l\xEDnea o estaci\xF3n" }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            "input",
            {
              type: "search",
              placeholder: "Buscar l\xEDnea o estaci\xF3n\u2026",
              value: search,
              onChange: (e) => onSearch(e.target.value)
            }
          )
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "mode-filters", children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            "button",
            {
              type: "button",
          ...
          MODE_ORDER.map((m) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            "button",
            {
              type: "button",
        ...
        (selectedLineId || filterMode || search) && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { type: "button", className: "clear-btn", onClick: onClearSelection, children: "Limpiar selecci\xF3n" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "line-list", children: [
        stationMatches.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("section", { className: "line-group-section", children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("h2", { children: [
            "Estaciones",
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { children: stationMatches.length })
          ] }),
          stationMatches.map((s) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
            "button",
            {
              type: "button",
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "line-badge station-badge", children: "\u25C9" }),
                /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "line-meta", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "line-name", children: s.name }),
                  /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "line-sub", children: s.district })
                ] })
              ]
            },
            s.id
        ...
        grouped.map(({ mode, items }) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("section", { className: "line-group-section", children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("h2", { children: [
            MODE_LABELS[mode],
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { children: items.length })
          ] }),
          items.map((line2) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            LineRow,
            {
              line: line2,
        ...
        filteredLines.length === 0 && stationMatches.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { className: "empty-list", children: "No hay resultados con ese criterio." })
      ] })
    ] });
  }
  ...
  function TopBar({ role, onRoleChange, clock, onZoomIn, onZoomOut, onReset }) {
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "top-bar", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "zoom-controls", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("button", { type: "button", onClick: onReset, "aria-label": "Centrar mapa", children: "\u2295" }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("button", { type: "button", onClick: onZoomIn, "aria-label": "Acercar", children: "+" })
      ] })
    ] });
  }
  ...
  function TransitMap({
    ...
    const isLineActive = (line2) => {
      ...
      if (highlightedMode) return line2.mode === highlightedMode;
      return true;
    };
        ...
        children: [
          ...
          sorted.map((line2) => {
            ...
            return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("g", { opacity: lineOpacity(line2), className: "line-group", children: [
              ...
              line2.mode === "hyperloop" && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
                "path",
                {
                  d,
                  fill: "none",
  ...
  (() => {
    const style = document.createElement("style");
    style.textContent = ".app {\n  display: grid;\n  grid-template-columns: minmax(280px, 340px) 1fr;\n  height: 100dvh;\n  width: 100%;\n  overflow: hidden;\n  background: #eef1f4;\n  position: relative;\n}\n\n.app.sidebar-collapsed {\n  grid-template-columns: 0 1fr;\n}\n\n.sidebar-slot {\n  min-width: 0;\n  overflow: hidden;\n  z-index: 30;\n  transition: width 0.25s ease;\n}\n\n.sidebar-toggle {\n  position: absolute;\n  top: 50%;\n  left: 340px;\n  transform: translate(-50%, -50%);\n  z-index: 40;\n  width: 1.6rem;\n  height: 3rem;\n  border: 1px solid rgba(26, 35, 50, 0.12);\n  border-radius: 0 8px 8px 0;\n  background: #1a2332;\n  color: #fff;\n  cursor: pointer;\n  font-size: 1rem;\n  line-height: 1;\n  box-shadow: 2px 0 12px rgba(0, 0, 0, 0.15);\n  transition: left 0.25s ease;\n}\n\n.app.sidebar-collapsed .sidebar-toggle {\n  left: 0;\n  border-radius: 0 8px 8px 0;\n}\n\n.map-stage {\n  position: relative;\n  min-width: 0;\n  background:\n    radial-gradient(ellipse at 70% 20%, rgba(56, 120, 160, 0.08), transparent 45%),\n    radial-gradient(ellipse at 20% 80%, rgba(196, 92, 38, 0.06), transparent 40%),\n    linear-gradient(160deg, #f4f6f8 0%, #e8ecf1 50%, #e3e8ee 100%);\n  overflow: hidden;\n}\n\n.map-viewport {\n  width: 100%;\n  height: 100%;\n  cursor: grab;\n  touch-action: none;\n  overflow: hidden;\n}\n\n.map-viewport:active {\n  cursor: grabbing;\n}\n\n.map-transform {\n  transform-origin: 0 0;\n  width: fit-content;\n  will-change: transform;\n}\n\n.map-hint {\n  position: absolute;\n  bottom: 0.85rem;\n  left: 50%;\n  transform: translateX(-50%);\n  margin: 0;\n  padding: 0.4rem 0.85rem;\n  border-radius: 999px;\n  background: rgba(26, 35, 50, 0.75);\n  color: rgba(255, 255, 255, 0.85);\n  font-size: 0.72rem;\n  font-weight: 500;\n  letter-spacing: 0.02em;\n  pointer-events: none;\n  white-space: nowrap;\n  z-index: 10;\n}\n\n@media (max-width: 860px) {\n  .app {\n    grid-template-columns: 1fr;\n    grid-template-rows: auto 1fr;\n  }\n\n  .app.sidebar-collapsed {\n    grid-template-columns: 1fr;\n    grid-template-rows: 0 1fr;\n  }\n\n  .sidebar-slot {\n    max-height: 42dvh;\n    border-bottom: 1px solid rgba(255, 255, 255, 0.06);\n  }\n\n  .app.sidebar-collapsed .sidebar-slot {\n    max-height: 0;\n  }\n\n  .sidebar-toggle {\n    top: auto;\n    bottom: 5.5rem;\n    left: 0.75rem;\n    transform: none;\n    width: 2.5rem;\n    height: 2.5rem;\n    border-radius: 50%;\n  }\n\n  .app.sidebar-collapsed .sidebar-toggle {\n    left: 0.75rem;\n  }\n\n  .map-hint {\n    font-size: 0.65rem;\n    bottom: 0.55rem;\n  }\n}\n";
    document.head.appendChild(style);
  })();
  ...
  function writeLineToUrl(lineId) {
    ...
    if (lineId) {
      const line2 = lines.find((l) => l.id === lineId);
      if (line2) url.searchParams.set("linea", line2.code);
    } else {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: `app ${sidebarOpen ? "" : "sidebar-collapsed"}`, children: [
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
        "button",
        {
          ...
          "aria-label": sidebarOpen ? "Ocultar men\xFA" : "Mostrar men\xFA",
          children: sidebarOpen ? "\u2039" : "\u203A"
        }
      ),
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "sidebar-slot", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
        SidePanel,
        {
          role,
          selectedLineId,
      ...
      /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("main", { className: "map-stage", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(MapLegend, {}),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
          DetailPanel,
          {
            role,

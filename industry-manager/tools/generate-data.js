...
// ——— Edificios únicos (sin Mk1/Mk2): cientos de tipologías distintas ———
const uniqueBuildings = [
  // Extracción
  ['mina_cobre_andaluza', 'Mina de cobre andaluza', 'extraccion', 'mina', 320000, 4],
  ['mina_hierro_astur', 'Mina de hierro asturiana', 'extraccion', 'mina', 380000, 5],
  ['mina_litio_salar', 'Mina de litio en salar', 'extraccion', 'mina', 920000, 4],
  ['cantera_caliza', 'Cantera de caliza', 'extraccion', 'mina', 180000, 3],
  ['cantera_marmol', 'Cantera de mármol', 'extraccion', 'mina', 260000, 3],
  ['pozo_offshore', 'Pozo offshore ligero', 'extraccion', 'pozo_petroleo', 2200000, 3],
  ['pozo_shale', 'Pozo de shale gas', 'extraccion', 'pozo_gas', 1400000, 3],
  ['granja_olivar', 'Granja-olivar intensivo', 'extraccion', 'granja', 210000, 6],
  ['granja_citricos', 'Granja de cítricos', 'extraccion', 'granja', 190000, 6],
  ['granja_invernadero', 'Invernadero industrial', 'extraccion', 'granja', 340000, 5],
  ['granja_algodon', 'Plantación de algodón', 'extraccion', 'granja', 160000, 5],
  ['granja_arroz', 'Arrozal industrial', 'extraccion', 'granja', 175000, 5],
  ['vivero_clonacion', 'Vivero de clonación vegetal', 'extraccion', 'granja', 280000, 4],
  ['aserradero_pino', 'Aserradero de pino', 'extraccion', 'aserradero', 110000, 3],
  ['aserradero_eucalipto', 'Aserradero de eucalipto', 'extraccion', 'aserradero', 125000, 3],
  ['pesqueria_lonja', 'Lonja y pesquería', 'extraccion', 'granja', 240000, 4],
  // Procesado metales
  ['fundicion_arco', 'Fundición de arco', 'procesado', 'fundicion', 1500000, 8],
  ['fundicion_induccion', 'Fundición por inducción', 'procesado', 'fundicion', 1350000, 7],
  ['acería_ld', 'Acería convertidor LD', 'procesado', 'fundicion', 2800000, 9],
  ['laminador_en_caliente', 'Laminador en caliente', 'procesado', 'laminacion', 1100000, 6],
  ['laminador_en_frio', 'Laminador en frío', 'procesado', 'laminacion', 1250000, 6],
  ['taller_forja', 'Taller de forja', 'procesado', 'laminacion', 680000, 5],
  ['taller_estampacion', 'Taller de estampación', 'procesado', 'laminacion', 720000, 5],
  ['galvanizadora', 'Línea de galvanizado', 'procesado', 'laminacion', 890000, 5],
  // Química
  ['reactor_amoniaco', 'Planta de amoníaco', 'quimica', 'planta_quimica', 3100000, 8],
  ['reactor_acido', 'Planta de ácidos', 'quimica', 'planta_quimica', 2700000, 7],
  ['planta_cloro', 'Planta cloro-álcali', 'quimica', 'planta_quimica', 2900000, 7],
  ['planta_polimeros_pe', 'Polímeros PE/PP', 'quimica', 'planta_polimeros', 2400000, 8],
  ['planta_polimeros_pvc', 'Polímeros PVC', 'quimica', 'planta_polimeros', 2300000, 7],
  ['planta_pinturas', 'Fábrica de pinturas', 'quimica', 'planta_quimica', 980000, 6],
  ['planta_detergentes', 'Planta de detergentes', 'quimica', 'planta_quimica', 860000, 6],
  ['planta_farma_api', 'Planta API farmacéutica', 'quimica', 'planta_farmaceutica', 4800000, 8],
  ['planta_vacunas', 'Planta de vacunas', 'quimica', 'planta_farmaceutica', 6200000, 7],
  ['planta_ferti_npk', 'Fertilizantes NPK', 'quimica', 'planta_fertilizantes', 1900000, 6],
  ['bioreactor_enzimas', 'Bioreactor de enzimas', 'quimica', 'planta_quimica', 3400000, 6],
  // Alimentación
  ['almazara_picual', 'Almazara Picual', 'alimentacion', 'almazara', 220000, 3],
  ['almazara_hojiblanca', 'Almazara Hojiblanca', 'alimentacion', 'almazara', 230000, 3],
  ['almazara_cooperativa', 'Almazara cooperativa', 'alimentacion', 'almazara', 180000, 4],
  ['bodega_malaga', 'Bodega de Málaga', 'alimentacion', 'almazara', 450000, 4],
  ['bodega_jerez_solera', 'Bodega solera Jerez', 'alimentacion', 'almazara', 620000, 4],
  ['bodega_rioja', 'Bodega Rioja', 'alimentacion', 'almazara', 580000, 4],
  ['secadero_jabugo', 'Secadero Jabugo', 'alimentacion', 'almazara', 410000, 3],
  ['secadero_seron', 'Secadero Serón', 'alimentacion', 'almazara', 360000, 3],
  ['molino_trigo', 'Molino de trigo', 'alimentacion', 'molino_harinero', 260000, 4],
  ['molino_maiz', 'Molino de maíz', 'alimentacion', 'molino_harinero', 250000, 4],
  ['azucarera_remolacha', 'Azucarera de remolacha', 'alimentacion', 'azucarera', 980000, 5],
  ['conservas_pescado', 'Conservas de pescado', 'alimentacion', 'almazara', 390000, 5],
  ['conservas_vegetal', 'Conservas vegetales', 'alimentacion', 'almazara', 340000, 5],
  ['lacteos_queseria', 'Quesería industrial', 'alimentacion', 'almazara', 470000, 4],
  ['cerveceria', 'Cervecería industrial', 'alimentacion', 'almazara', 880000, 5],
  ['refineria_aceite', 'Refinería de aceites', 'alimentacion', 'almazara', 760000, 5],
  // Energía
  ['parque_solar_tracker', 'Parque solar con trackers', 'energia', 'parque_solar', 2600000, 2],
  ['parque_solar_flotante', 'Parque solar flotante', 'energia', 'parque_solar', 3100000, 2],
  ['parque_eolico_offshore', 'Eólica offshore', 'energia', 'parque_eolico', 5200000, 2],
  ['parque_eolico_sierra', 'Eólica de sierra', 'energia', 'parque_eolico', 2900000, 2],
  ['central_ciclo_gas', 'Ciclo combinado gas', 'energia', 'central_ciclo_combinado', 3800000, 4],
  ['central_biomasa_olivo', 'Biomasa de olivo', 'energia', 'central_biomasa', 1600000, 3],
  ['central_geotermica', 'Central geotérmica', 'energia', 'central_biomasa', 4200000, 3],
  ['planta_hidrogeno_verde', 'Hidrógeno verde', 'energia', 'planta_quimica', 6500000, 6],
  ['subestacion_400kv', 'Subestación 400 kV', 'energia', 'parque_solar', 1200000, 1],
  ['bateria_grid', 'Almacenamiento grid 100 MWh', 'energia', 'parque_solar', 4800000, 2],
  ['refineria_costera', 'Refinería costera', 'energia', 'refineria', 6200000, 10],
  // Alta tech
  ['fab_smt_movil', 'Fábrica SMT móviles', 'alta_tech', 'electronica', 4100000, 10],
  ['fab_smt_auto', 'Fábrica SMT automoción', 'alta_tech', 'electronica', 4300000, 10],
  ['fab_semicon_200', 'Fab semicon 200 mm', 'alta_tech', 'electronica', 18000000, 12],
  ['fab_semicon_300', 'Fab semicon 300 mm', 'alta_tech', 'electronica', 45000000, 14],
  ['planta_baterias_ev', 'Planta baterías EV', 'alta_tech', 'electronica', 12000000, 10],
  ['planta_baterias_lfp', 'Planta celdas LFP', 'alta_tech', 'electronica', 9000000, 9],
  ['planta_pcb', 'Planta de PCB', 'alta_tech', 'electronica', 2800000, 8],
  ['planta_displays', 'Planta de displays', 'alta_tech', 'electronica', 7500000, 8],
  ['planta_automocion_ev', 'Montaje EV', 'alta_tech', 'planta_automocion', 11000000, 12],
  ['planta_automocion_furgon', 'Montaje furgonetas', 'alta_tech', 'planta_automocion', 8500000, 11],
  ['data_center_edge', 'Data center edge', 'alta_tech', 'electronica', 3900000, 6],
  ['data_center_hpc', 'Data center HPC', 'alta_tech', 'electronica', 9800000, 8],
  ['taller_drones', 'Taller de drones', 'alta_tech', 'electronica', 1200000, 5],
  ['taller_robotica', 'Taller de robótica', 'alta_tech', 'electronica', 2100000, 6],
  ['hangar_satelite', 'Hangar de satélites', 'alta_tech', 'electronica', 15000000, 8],
  // Logística
  ['almacen_automatizado', 'Almacén automatizado', 'logistica', 'almacen', 920000, 0],
  ['almacen_frigorifico', 'Almacén frigorífico', 'logistica', 'almacen', 680000, 0],
  ['almacen_peligroso', 'Almacén mercancías peligrosas', 'logistica', 'almacen', 740000, 0],
  ['puerto_contenedores', 'Terminal de contenedores', 'logistica', 'puerto', 3200000, 2],
  ['puerto_graneles', 'Terminal de graneles', 'logistica', 'puerto', 2400000, 2],
  ['puerto_pasajeros_carga', 'Puerto mixto', 'logistica', 'puerto', 2800000, 2],
  ['terminal_ave_carga', 'Terminal AVE carga', 'logistica', 'terminal_ferroviaria', 1600000, 2],
  ['hub_camionero', 'Hub camionero', 'logistica', 'almacen', 540000, 1],
  ['aeropuerto_carga', 'Terminal carga aérea', 'logistica', 'puerto', 4500000, 2],
  ['silo_cereales', 'Silo de cereales', 'logistica', 'almacen', 210000, 0],
  ['deposito_crudo', 'Depósito de crudo', 'logistica', 'almacen', 1100000, 0],
  // Reciclaje / circular
  ['reciclaje_plastico', 'Reciclaje de plásticos', 'reciclaje', 'reciclaje', 780000, 6],
  ['reciclaje_metal', 'Reciclaje de metales', 'reciclaje', 'reciclaje', 860000, 6],
  ['reciclaje_raee', 'Reciclaje RAEE', 'reciclaje', 'reciclaje', 940000, 6],
  ['reciclaje_papel', 'Reciclaje de papel', 'reciclaje', 'reciclaje', 620000, 5],
  ['compostaje_industrial', 'Compostaje industrial', 'reciclaje', 'reciclaje', 380000, 4],
  // I+D / admin
  ['lab_materiales', 'Lab. de materiales', 'investigacion', 'centro_investigacion', 2200000, 4],
  ['lab_biotecnologia', 'Lab. de biotecnología', 'investigacion', 'centro_investigacion', 3100000, 5],
  ['lab_baterias', 'Lab. de baterías', 'investigacion', 'centro_investigacion', 2800000, 4],
  ['lab_ia_industrial', 'Lab. IA industrial', 'investigacion', 'centro_investigacion', 2600000, 4],
  ['campus_formacion', 'Campus de formación', 'investigacion', 'centro_investigacion', 1400000, 3],
  ['sede_regional', 'Sede regional', 'admin', 'oficina', 700000, 0],
  ['sede_global', 'Sede global', 'admin', 'oficina', 2500000, 0],
  ['centro_control', 'Centro de control SCADA', 'admin', 'oficina', 1100000, 2],
  // Procesado diverso
  ['cementera_portland', 'Cementera Portland', 'procesado', 'cementera', 1700000, 6],
  ['planta_hormigon_pre', 'Hormigón prefabricado', 'procesado', 'planta_hormigon', 420000, 4],
  ['vidriera_float', 'Vidriera float', 'procesado', 'vidriera', 1400000, 5],
  ['papelera_kraft', 'Papelera kraft', 'procesado', 'papelera', 1800000, 7],
  ['cartonaje_ondulado', 'Cartonaje ondulado', 'procesado', 'cartonaje', 480000, 4],
  ['textil_denim', 'Planta denim', 'procesado', 'textil', 560000, 6],
  ['textil_tecnico', 'Textil técnico', 'procesado', 'textil', 720000, 6],
  ['planta_caucho_neumatico', 'Planta de neumáticos', 'procesado', 'planta_caucho', 1900000, 6],
  ['planta_muebles', 'Fábrica de mobiliario', 'procesado', 'planta_consumo', 680000, 6],
  ['planta_juguetes', 'Fábrica de juguetes', 'procesado', 'planta_consumo', 540000, 6],
  ['planta_cosmetica', 'Planta cosmética', 'procesado', 'planta_consumo', 790000, 5],
  ['planta_ceramica_triana', 'Cerámica Triana', 'procesado', 'planta_consumo', 430000, 5],
  ['planta_corcho_alcoro', 'Corcho Alcornocal', 'procesado', 'planta_consumo', 390000, 4],
  ['astillero_malaga', 'Astillero Málaga', 'procesado', 'planta_automocion', 6200000, 10],
  ['taller_ferro_vias', 'Taller ferroviario vías', 'procesado', 'planta_automocion', 3100000, 8],
  ['planta_impresion_3d', 'Planta impresión 3D metal', 'procesado', 'planta_consumo', 2100000, 6],
  ['planta_optica_led', 'Planta óptica LED', 'procesado', 'electronica', 1300000, 5],
  ['planta_agua_etap', 'ETAP urbana-industrial', 'procesado', 'planta_quimica', 1500000, 5],
  ['planta_epi', 'Planta de EPI', 'procesado', 'planta_consumo', 460000, 5],
  // Más tipologías únicas (sin Mk)
  ['mina_bauxita', 'Mina de bauxita', 'extraccion', 'mina', 410000, 4],
  ['mina_fosfato', 'Mina de fosfato', 'extraccion', 'mina', 290000, 4],
  ['mina_sal_marina', 'Salinas industriales', 'extraccion', 'mina', 150000, 3],
  ['cantera_yeso', 'Cantera de yeso', 'extraccion', 'mina', 140000, 3],
  ['pozo_geotermico', 'Pozo geotérmico', 'extraccion', 'pozo_gas', 980000, 2],
  ['granja_vacuno', 'Complejo vacuno', 'extraccion', 'granja', 280000, 6],
  ['granja_avicola', 'Complejo avícola', 'extraccion', 'granja', 220000, 5],
  ['granja_porcino', 'Complejo porcino', 'extraccion', 'granja', 260000, 5],
  ['aserradero_roble', 'Aserradero de roble', 'extraccion', 'aserradero', 145000, 3],
  ['vivero_forestal', 'Vivero forestal', 'extraccion', 'granja', 120000, 3],
  ['concentradora_flotacion', 'Concentradora por flotación', 'procesado', 'planta_concentracion', 620000, 6],
  ['sinterizacion', 'Planta de sinterización', 'procesado', 'fundicion', 980000, 6],
  ['taller_mecanizado_cnc', 'Taller CNC', 'procesado', 'laminacion', 740000, 5],
  ['taller_soldadura_robot', 'Soldadura robótica', 'procesado', 'laminacion', 810000, 5],
  ['planta_pintura_catodica', 'Pintura catódica', 'procesado', 'laminacion', 690000, 4],
  ['planta_tubos', 'Planta de tubos', 'procesado', 'laminacion', 920000, 6],
  ['planta_alambre', 'Planta de alambre', 'procesado', 'laminacion', 540000, 5],
  ['reactor_metanol', 'Planta de metanol', 'quimica', 'planta_quimica', 2600000, 7],
  ['planta_etileno', 'Crackeo de etileno', 'quimica', 'planta_polimeros', 4100000, 8],
  ['planta_adhesivos', 'Planta de adhesivos', 'quimica', 'planta_quimica', 780000, 5],
  ['planta_lubricantes', 'Planta de lubricantes', 'quimica', 'planta_quimica', 910000, 5],
  ['planta_cosmeceutica', 'Planta cosmecéutica', 'quimica', 'planta_farmaceutica', 2200000, 6],
  ['destileria_industrial', 'Destilería industrial', 'alimentacion', 'almazara', 670000, 4],
  ['planta_zumos', 'Planta de zumos', 'alimentacion', 'almazara', 390000, 4],
  ['planta_congelados', 'Planta de congelados', 'alimentacion', 'almazara', 520000, 5],
  ['panificadora_industrial', 'Panificadora industrial', 'alimentacion', 'molino_harinero', 310000, 4],
  ['chocolatera', 'Chocolatera industrial', 'alimentacion', 'almazara', 480000, 4],
  ['central_hidro', 'Minihidráulica', 'energia', 'central_biomasa', 2100000, 2],
  ['parque_solar_bifacial', 'Solar bifacial', 'energia', 'parque_solar', 2900000, 2],
  ['parque_eolico_repuesto', 'Eólica con repotenciación', 'energia', 'parque_eolico', 3300000, 2],
  ['planta_biogas', 'Planta de biogás', 'energia', 'central_biomasa', 980000, 3],
  ['cogen_industrial', 'Cogeneración industrial', 'energia', 'central_ciclo_combinado', 2400000, 3],
  ['fab_sensores', 'Fábrica de sensores', 'alta_tech', 'electronica', 3600000, 8],
  ['fab_leds', 'Fábrica de LEDs', 'alta_tech', 'electronica', 2900000, 7],
  ['planta_cargadores_ev', 'Planta cargadores EV', 'alta_tech', 'electronica', 1800000, 6],
  ['planta_bicicletas', 'Planta de bicicletas', 'alta_tech', 'planta_automocion', 920000, 7],
  ['planta_motos', 'Planta de motocicletas', 'alta_tech', 'planta_automocion', 2100000, 8],
  ['laboratorio_chips', 'Lab. de chips piloto', 'alta_tech', 'electronica', 8500000, 6],
  ['almacen_crossdock', 'Cross-docking', 'logistica', 'almacen', 480000, 0],
  ['almacen_autopartes', 'Almacén autopartes', 'logistica', 'almacen', 560000, 0],
  ['puerto_ro_ro', 'Terminal Ro-Ro', 'logistica', 'puerto', 2700000, 2],
  ['dry_port', 'Puerto seco', 'logistica', 'terminal_ferroviaria', 1400000, 2],
  ['centro_ultima_milla', 'Centro última milla', 'logistica', 'almacen', 390000, 1],
  ['reciclaje_vidrio', 'Reciclaje de vidrio', 'reciclaje', 'reciclaje', 510000, 5],
  ['reciclaje_baterias', 'Reciclaje de baterías', 'reciclaje', 'reciclaje', 1600000, 6],
  ['reciclaje_textil', 'Reciclaje textil', 'reciclaje', 'reciclaje', 440000, 4],
  ['planta_upcycling', 'Upcycling industrial', 'reciclaje', 'reciclaje', 620000, 5],
  ['lab_nanomateriales', 'Lab. nanomateriales', 'investigacion', 'centro_investigacion', 3500000, 4],
  ['lab_alimentos', 'Lab. de alimentos', 'investigacion', 'centro_investigacion', 1600000, 3],
  ['observatorio_mercado', 'Observatorio de mercado', 'admin', 'oficina', 420000, 0],
  ['oficina_export', 'Oficina de exportación', 'admin', 'oficina', 380000, 0],
  ['planta_muebles_oficina', 'Mobiliario de oficina', 'procesado', 'planta_consumo', 610000, 5],
  ['planta_iluminacion', 'Iluminación industrial', 'procesado', 'electronica', 880000, 5],
  ['planta_envases_vidrio', 'Envases de vidrio', 'procesado', 'vidriera', 990000, 5],
  ['planta_envases_metal', 'Envases metálicos', 'procesado', 'laminacion', 760000, 5],
  ['planta_flexografia', 'Imprenta flexográfica', 'procesado', 'cartonaje', 540000, 4],
  ['planta_calzado', 'Fábrica de calzado', 'procesado', 'textil', 470000, 5],
  ['planta_deportiva', 'Textil deportivo', 'procesado', 'textil', 590000, 5],
  ['taller_naval_reparacion', 'Taller naval reparación', 'procesado', 'planta_automocion', 2800000, 7],
  ['planta_ascensores', 'Planta de ascensores', 'procesado', 'planta_consumo', 1400000, 6],
  ['planta_hvac', 'Planta HVAC', 'procesado', 'planta_consumo', 1100000, 6],
];

// Expandir con series regionales y urbanas únicas (nombres distintos, sin Mk)
const regions = [
  'Mediterráneo', 'Atlántico', 'Cantábrico', 'Meseta', 'Andino', 'Nórdico',
  'Sahariano', 'Pacífico', 'Báltico', 'Índico', 'Caribe', 'Alpino',
  'Ibérico', 'Magrebí', 'Danubio', 'Rin', 'Adriático', 'Egeo',
];
const cityTags = [
  'Málaga', 'Sevilla', 'Cádiz', 'Almería', 'Granada', 'Córdoba', 'Huelva', 'Jaén',
  'Valencia', 'Barcelona', 'Bilbao', 'Vigo', 'Santander', 'Zaragoza', 'Murcia', 'Alicante',
  'Lisboa', 'Oporto', 'Marsella', 'Génova', 'Nápoles', 'Atenas', 'Estambul', 'Casablanca',
  'Tánger', 'Rotterdam', 'Amberes', 'Hamburgo', 'Gdansk', 'Shanghái', 'Busán', 'Singapur',
];
const roles = [
  ['centro_logistico', 'Centro logístico', 'logistica', 'almacen', 400000, 1],
  ['nave_ligera', 'Nave de ensamblaje ligero', 'procesado', 'planta_consumo', 520000, 5],
  ['nave_pesada', 'Nave de ensamblaje pesado', 'procesado', 'planta_automocion', 980000, 7],
  ['planta_auxiliar', 'Planta auxiliar de utilities', 'energia', 'parque_solar', 640000, 2],
  ['taller_mantenimiento', 'Taller de mantenimiento', 'procesado', 'laminacion', 310000, 3],
  ['laboratorio_calidad', 'Laboratorio de calidad', 'investigacion', 'centro_investigacion', 870000, 3],
  ['camara_maduracion', 'Cámara de maduración', 'alimentacion', 'almazara', 290000, 2],
  ['secadero_solar', 'Secadero solar', 'alimentacion', 'almazara', 210000, 2],
  ['planta_envasado', 'Planta de envasado', 'procesado', 'cartonaje', 450000, 4],
  ['hub_export', 'Hub de exportación', 'logistica', 'puerto', 1800000, 2],
  ['taller_prototipos', 'Taller de prototipos', 'investigacion', 'centro_investigacion', 760000, 3],
  ['nave_coldchain', 'Nave cadena de frío', 'logistica', 'almacen', 580000, 1],
];
regions.forEach((reg, ri) => {
  roles.forEach(([idBase, nameBase, cat, family, cost, slots], roleI) => {
    const id = `${idBase}_${idify(reg)}`;
    uniqueBuildings.push([
      id,
      `${nameBase} ${reg}`,
      cat,
      family,
      Math.round(cost * (0.9 + (ri % 5) * 0.08 + roleI * 0.02)),
      slots + (ri % 3),
    ]);
  });
});
// Variantes urbanas: una tipología distinta por ciudad (sin Mk)
const urbanRoles = [
  ['lonja', 'Lonja industrial', 'alimentacion', 'almazara', 320000, 3],
  ['poligono', 'Nave de polígono', 'procesado', 'planta_consumo', 410000, 4],
  ['muelle', 'Muelle de carga', 'logistica', 'puerto', 950000, 2],
  ['tecno', 'Parque tecnológico', 'alta_tech', 'electronica', 2200000, 6],
  ['agrohub', 'Agrohub', 'extraccion', 'granja', 280000, 5],
];
cityTags.forEach((city, ci) => {
  const role = urbanRoles[ci % urbanRoles.length];
  const [idBase, nameBase, cat, family, cost, slots] = role;
  uniqueBuildings.push([
    `${idBase}_${idify(city)}`,
    `${nameBase} ${city}`,
    cat,
    family,
    Math.round(cost * (0.85 + (ci % 7) * 0.05)),
    slots + (ci % 2),
  ]);
});

uniqueBuildings.forEach(([id, name, category, family, cost, slots], i) => {
  ...
  buildings.push({
    ...
    power: 80 + (i % 40) * 35,
    water: 20 + (i % 30) * 12,
    storage: 1500 + (i % 50) * 400,
    pollutionBase: Math.max(0, (i % 8) - 2),
    desc: `${name}. Tipología única · familia de recetas: ${family}.`,
    logoHint: category,
  });
});

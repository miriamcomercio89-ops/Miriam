...
LINE = {
    ...
    "name_old": "Oper, Karlsplatz → Reumannplatz",
    "color": "#1B1B1B",
    "text": "#F5A623",
    "kind": "Semi-exprés / pocos andenes",
    "service": "06:30 – 21:00",
    "distance_km": 4.5,
    "runtime_min": 14,
    "headway_peak": 10,
    "headway_off": 15,
    "headway_eve": 20,
    "demand": "Media-alta en punta",
    "target_load": "65–80 %",
    "fleet_units": 6,
    "vehicles": [
        ("StadtRegioTram (SRT)", "DLC StadtRegioTram", 160, "principal / semi-rápido"),
        ("Flexity Wien", "DLC Flexity", 210, "refuerzo punta"),
    ],
...
def build():
    ...
    story.append(Paragraph(
        "Laborable ×1,0 · Verano ×1,20 · Feria ×0,85 · Navidad ×0,90 · "
        "Solo diurno hasta 21:00. Punta: cada 10 min. No sustituye a L3 en valle profundo.",
        STY["Body"]))
    ...
    hubs_txt = [
        ("Plaza de la Ópera", "Cabecera norte; cruce L1/C."),
        ("Paseo de los Naranjos", "Única parada intermedia de casco."),
        ("Plaza de la Concordia", "Cabecera sur; Depot / L3 / L5 / L6."),
    ]
    ...
    checks = [
        ...
        "Comprobar si en CTS el trazo permite saltar paradas o hay que listar las 5",
        "Probar Free Roam (~14 min)",
        "Timetable Generator: 4 franjas (sin servicio nocturno propio)",
    ]
    for c in checks:

# -*- coding: utf-8 -*-
"""
PDF completo — Línea 10 de tranvía (documento: «71»).
Orden EMT: 10 · Código original: 71.
"""
...
OUT = Path(__file__).resolve().parent / "lineas" / "linea_10_tranvia.pdf"
...
LINE = {
    ...
    "code_doc": "71",
    "mode": "Tranvía",
    "name": "Barrio del Farallón – Plaza del Anillo Norte",
    "name_old": "Kaiserebersdorf, Zinnergasse → Schottenring",
    "color": "#4A90A4",
    "text": "#FFFFFF",
    "kind": "Diametral / sureste – casco – anillo",
    "service": "05:40 – 23:50",
    "distance_km": 7.9,
    "runtime_min": 27,
    "headway_peak": 8,
    ...
    "vehicles": [
        ...
        ("Flexity Wien", "DLC Flexity", 210, "refuerzo"),
    ],
    "depot": "Depot Süd / Cocheras Favorita",
    "zones": ["A", "B", "C"],
    "notes": (
        "Documento «71» → EMT Línea 10. Une Farallón con Anillo Norte por Embarcadero, "
        "Cipreses, Ayuntamiento, Naranjos, Ópera, Artes y Teatro Cervantes. "
        "Alternativa este–casco a L1 en el tramo céntrico."
    ),
}

STOPS = [
    ("Kaiserebersdorf, Zinnergasse", "Barrio del Farallón", "Eglundsdorf", False, "C", True),
    ("Svetelskystraße", "Calle del Embarcadero", "Stadtgraben", False, "C", False),
...
def build():
    ...
    story.append(Paragraph(
        ...
        "Día de partido: enlace en casco hacia L6 / R-EST.",
        STY["Body"]))
    ...
    hubs_txt = [
        ("Barrio del Farallón", "Cabecera SE compartida con L5."),
        ("Plaza del Ayuntamiento", "Casco; cruce L1/L2/L8."),
        ("Plaza de la Ópera", "Hub turístico L1/L8/L9."),
        ("Plaza del Anillo Norte", "Cabecera norte; cruce L1/L7."),
    ]
    ...
    checks = [
        ...
        "Renombrar las 9 paradas (varias ya en L1–L9)",
        "Cabeceras: Barrio del Farallón ↔ Plaza del Anillo Norte",
        "Asignar ULF B1 + Flexity",
        ...
        "Comprobar vía Farallón → casco → Anillo en capa Tram",
        "Probar Free Roam (~27 min)",
    ...
    story.append(Spacer(1, 4))
    story.append(Paragraph(
        "Siguiente del documento: D → Línea D (o 11).",
        STY["Small"]))

# -*- coding: utf-8 -*-
"""
PDF completo — Línea 7 de tranvía (documento: «31»).
Orden EMT: 7 · Código original: 31.
"""
...
OUT = Path(__file__).resolve().parent / "lineas" / "linea_07_tranvia.pdf"
...
LINE = {
    ...
    "code_doc": "31",
    "mode": "Tranvía",
    "name": "Plaza del Anillo Norte – Plaza del Nuevo Norte",
    "name_old": "Schottenring → Friedrich-Engels-Platz",
    "color": "#6B2D5C",
    "text": "#FFFFFF",
    "kind": "Lanzadera corta / norte",
    "service": "06:00 – 23:00",
    "distance_km": 3.1,
    "runtime_min": 11,
    "headway_peak": 6,
    ...
    "fleet_units": 5,
    "vehicles": [
        ("E1 Viena (clásico)", "DLC E1 Vienna", 100, "principal / patrimonial"),
        ("DÜWAG GT6", "DLC GT6", 121, "refuerzo"),
    ],
    "depot": "Depot Süd / Depósito Sur",
    "zones": ["A", "B", "C"],
    "notes": (
        "Documento «31» → EMT Línea 7. Lanzadera corta de 5 paradas: Anillo Norte → "
        "Muelle de la Sal → Puerto → Alta Norte → Nuevo Norte. Ideal para flota clásica "
        "(E1/GT6) y para alimentar el norte sin saturar L2."
    ),
}
...
def build():
    ...
    brows = [[Paragraph("<b>Franja</b>", STY["Tiny"]),
              ...
              Paragraph("<b>Ej. salidas cabecera Anillo Norte</b>", STY["Tiny"])]]
    ...
    story.append(Paragraph(
        "Laborable ×1,0 · Verano ×1,15 · Feria ×0,85 · Navidad ×0,90 · "
        "Día de partido: sin refuerzo propio (viajeros al estadio usan L6 u otras).",
        STY["Body"]))
    ...
    hubs_txt = [
        ("Plaza del Anillo Norte", "Cabecera sur de la lanzadera; cruce con L1."),
        ("Plaza del Puerto", "Correspondencia este / muelle."),
        ("Plaza del Nuevo Norte", "Cabecera norte compartida con L2."),
    ]
    ...
    checks = [
        ...
        "Renombrar las 5 paradas (casi todas ya en L1/L2)",
        "Cabeceras: Plaza del Anillo Norte ↔ Plaza del Nuevo Norte",
        "Asignar E1 + GT6 (flota clásica)",
        ...
        "Comprobar vía corta Anillo → Nuevo Norte en capa Tram",
        "Probar Free Roam (~11 min)",
    ...
    story.append(Spacer(1, 4))
    story.append(Paragraph(
        "Siguiente del documento: suele ser la 46 → Línea 8 EMT.",
        STY["Small"]))

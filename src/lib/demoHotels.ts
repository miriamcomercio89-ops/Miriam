...
export function generateDemoHotels(count: number, gameDayNow: number): Hotel[] {
  ...
  for (let i = 0; i < count; i++) {
    ...
    const hotel: Hotel = {
      ...
      buffetTypes: i % 5 === 0 ? [] : i % 3 === 0 ? ['continental', 'americano'] : ['continental'],
      barTypes: i % 6 === 0 ? [] : i % 4 === 0 ? ['lobby', 'azotea'] : ['lobby'],
      restaurantConcepts: i % 6 === 0 ? [] : i % 3 === 0 ? ['a_la_carta', 'tematico'] : ['a_la_carta'],
      lateCheckout: i % 3 === 0,
      airportDesk: i % 7 === 0,
      quietHours: i % 4 === 0,
      bikeRental: i % 5 === 0,
